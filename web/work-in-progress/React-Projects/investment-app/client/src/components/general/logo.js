...
const Logo = (props) => {
  ...
  useEffect(() => {
    if (props.responsive) {
      setLogo(
        <div className="logoResponsiveBox">
          <picture className="logoResponsiveHTMLPicture">
            <source media="(max-width: 999px)" srcSet={`${logo40p} 1x, ${logo80p} 2x, ${logo120p} 3x, ${logo160p} 4x, ${logo200p} 5x`} />
            <source
      ...
      setLogo(
        <div className="logoBox">
          <picture className="logoHTMLPicture">
            <source
              media="(min-width: 0px)"
              srcSet={`${logo80p} 0.5x, ${logo120p} 1x, ${logo160p} 1.5x, ${logo200p} 2x, ${logo240p} 2.5x, ${logo280p} 3x, ${logo320p} 3.5x, ${logo360p} 4x, ${logo400p} 4.5x`}
            />
