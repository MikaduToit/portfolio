        ...
        <div id="displayContainer">
            ...
            <div id="navigationMenu"><!--Element Container-->
                <div id="menuFilterLayer">
                    ...
                    <div class="navigationBarSectionHeading">ADMIN</div>
                    <button class="navigationBarTabSelector" id="tokenTransactionTabSelector">Token Transaction</button>
                    <button class="navigationBarTabSelector" id="invoiceEntryTabSelector">Invoice Entry</button>
                    <button class="navigationBarTabSelector" id="customerWalletTabSelector" hidden>Customer Wallet</button>
                    <button class="navigationBarTabSelector" id="customerTransactionLogTabSelector" hidden>Customer Transaction Log</button>
                    <button class="navigationBarTabSelector" id="userRegistrationTabSelector">User Registration</button>
            ...
            <div id="contentDisplayContainer"><!--Element Container-->
                <div id="filterLayer">
                                        ...
                                        <div class="personalInformationFormFlexContainer" id="personalInformationFormFlexContainer2">
                                            ...
                                            <div class="textInputAltContainer">
                                                <select class="dropdownListAlt" name="personalCountry" required disabled>
                                                    ...
                                                    <option value="Aland Islands">Aland Islands</option><!--May need to add support for the special character �, and do the same for ShippingCountry-->
                    ...
                    <div class="contentDisplay" id="tokenTransactionTab"><!--Page Tab-->
                        <div class="contentDisplayNonFlexBox">
                            <div class="container" id="tokenTFormContainer">
                                <div class="internalContainer" id="tokenTFormInternalContainer">
                                    <div id="tokenTFormHeadingContainer">
                                        <img id="tokenTIcon" src="./assets/images/TokenIcon.png"/>
                                    </div>
                                    <form id="tokenTDataEntryForm" autocomplete="off" onkeydown="return event.key != 'Enter';">
                                        
                                        <div id="tokenTFormHeading">Token Transaction</div>
                                        
                                        <div class="requiredFieldsKey">* required</div>

                                        <div class="textInputContainerFlex100">
                                            <div class="dropdownListContainer" id="tokenTCustomerSelectDropdownContainer">
                                                <select class="dropdownList" id="tokenTCustomerSelect" name="tokenTCustomerSelect" required>
                                                    <option class="dropdownListPlaceholder" value="" selected disabled>Please Select Customer</option>
                                                </select>
                                                <span class="dropdownListLabel">Customer *</span>
                                                <img class="dropdownListArrow" src="./assets/images/DropdownArrowIcon.png"/>
                                            </div>
                                        </div>
                                        <!--Section Start-->
                                        <div class="sectionSpacerContainer">
                                            <hr class="tokenTSectionSpacerLine">
                                            <span class="sectionSpacerLabel">Product Information</span>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="tokenTDropdownListContainer">
                                                <select class="dropdownList" id="tokenTTransactionType" name="tokenTTransactionType" required>
                                                    <option value="Tokens Received">Tokens Received</option>
                                                    <option value="Tokens Paid">Tokens Paid</option>
                                                </select>
                                                <span class="dropdownListLabel">Transaction Type *</span>
                                                <img class="dropdownListArrow" src="./assets/images/DropdownArrowIcon.png"/>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex100">
                                            <div class="numberInputContainer">
                                                <input class="numberInput" type="number" id="tokenTProductQuantity" name="tokenTProductQuantity" min="1" max="9999999999" step="1" value="1" onfocus="this.select();" required></input>
                                                <span class="numberInputLabel">Product Quantity *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex100">
                                            <div class="txtInputContainer" id="tokenTProductNameContainer">
                                                <input class="textInput" type="text" name="tokenTProductName" placeholder="" maxlength="255" required></input>
                                                <span class="floatingLabel">Product Name *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="text" name="tokenTProductOptions" placeholder="" maxlength="255"></input>
                                                <span class="floatingLabel">Product Options</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="text" name="tokenTProductSKU" placeholder="" maxlength="255" required></input>
                                                <span class="floatingLabel">Product SKU *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="numberInputContainer">
                                                <input class="textNumberInput" type="text" name="tokenTProductPrice" value="0.00" pattern="(\d{1,20})+([.,]{1}\d{2})" title="Value must include only digits, a '.' or ',' and two decimal places" onfocus="this.select();" maxlength="23"></input>
                                                <span class="numberInputLabel">Product Price</span>
                                                <span class="currency">&euro;</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="dateInputContainer" id="tokenTProductEOLContainer" hidden>
                                                <input class="dateInput" type="date" name="tokenTProductEOL"></input>
                                                <span class="dateInputLabel">Product EOL</span>
                                            </div>
                                        </div>
                                        <!--Section End-->
                                        <!--Section Start-->
                                        <div id="tokenTPaymentAndShippingContainer">
                                            <div class="sectionSpacerContainer">
                                                <hr class="tokenTSectionSpacerLine">
                                                <span class="sectionSpacerLabel">Payment and Shipping</span>
                                            </div>
                                            <div class="textInputContainerFlex50">
                                                <div class="tokenTDropdownListContainer">
                                                    <select class="dropdownList" name="tokenTPaymentMethod" required>
                                                        <option value="Upfront">Upfront</option>
                                                        <option value="Monthly Installment" disabled>Monthly Installment</option>
                                                        <option value="Annual Installment" disabled>Annual Installment</option>
                                                        <option value="Percentage of Income" disabled>Percentage of Income</option>
                                                        <!--Enabling some of these requires additional features to be added first.-->
                                                    </select>
                                                    <span class="dropdownListLabel">Payment Method *</span>
                                                    <img class="dropdownListArrow" src="./assets/images/DropdownArrowIcon.png"/>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex50">
                                                <div class="tokenTDropdownListContainer">
                                                    <select class="dropdownList" id="tokenTPaymentStatus" name="tokenTPaymentStatus" required>
                                                        <option value="Pending" selected>Pending</option>
                                                        <option value="Paid">Paid</option>
                                                    </select>
                                                    <span class="dropdownListLabel">Payment Status *</span>
                                                    <img class="dropdownListArrow" src="./assets/images/DropdownArrowIcon.png"/>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex50">
                                                <div class="tokenTDropdownListContainer">
                                                    <select class="dropdownList" id="tokenTShippingStatus" name="tokenTShippingStatus" required>
                                                        <option value="Processing" selected>Processing</option>
                                                        <option value="Shipped">Shipped</option>
                                                    </select>
                                                    <span class="dropdownListLabel">Shipping Status *</span>
                                                    <img class="dropdownListArrow" src="./assets/images/DropdownArrowIcon.png"/>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex50">
                                                <div class="dateInputContainer">
                                                    <input class="dateInput" type="date" id="tokenTShippedAt" name="tokenTShippedAt" required disabled></input>
                                                    <span class="dateInputLabel">Shipped At *</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex100">
                                                <div class="tokenTDropdownListContainer">
                                                    <select class="dropdownList" id="tokenTShippingMethod" name="tokenTShippingMethod" required disabled>
                                                        <option value="" selected></option>
                                                        <option value="Digital">Digital</option>
                                                        <option value="Courier">Courier</option>
                                                        <option value="Postal">Postal</option>
                                                    </select>
                                                    <span class="dropdownListLabel">Shipping Method *</span>
                                                    <img class="dropdownListArrow" src="./assets/images/DropdownArrowIcon.png"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="sectionSpacerContainer">
                                            <hr class="tokenTSectionSpacerLine">
                                            <span class="sectionSpacerLabel">Token Transactions</span>
                                        </div>
                                        <div class="tokenAllocationContainer">
                                            <div class="tokenAllocationHeading">Subtotals</div>

                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTSubtotalMQT" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" required></input>
                                                    <span class="tokenTInputLabel">MQ T</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTSubtotalCT9" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" required></input>
                                                    <span class="tokenTInputLabel">CT 9</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTSubtotalCT8" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" required></input>
                                                    <span class="tokenTInputLabel">CT 8</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTSubtotalCT7" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" required></input>
                                                    <span class="tokenTInputLabel">CT 7</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTSubtotalCT6" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" required></input>
                                                    <span class="tokenTInputLabel">CT 6</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTSubtotalCT5" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" required></input>
                                                    <span class="tokenTInputLabel">CT 5</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTSubtotalCT4" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" required></input>
                                                    <span class="tokenTInputLabel">CT 4</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTSubtotalCT3" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" required></input>
                                                    <span class="tokenTInputLabel">CT 3</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTSubtotalCT2" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" required></input>
                                                    <span class="tokenTInputLabel">CT 2</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTSubtotalCT1" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" required></input>
                                                    <span class="tokenTInputLabel">CT 1</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tokenAllocationContainer" id="tokenTShippingCostsContainer">
                                            <div class="tokenAllocationHeading">Shipping Costs</div>

                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTShippingCostMQT" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" required></input>
                                                    <span class="tokenTInputLabel">MQ T</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTShippingCostCT9" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" required></input>
                                                    <span class="tokenTInputLabel">CT 9</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTShippingCostCT8" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" required></input>
                                                    <span class="tokenTInputLabel">CT 8</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTShippingCostCT7" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" required></input>
                                                    <span class="tokenTInputLabel">CT 7</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTShippingCostCT6" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" required></input>
                                                    <span class="tokenTInputLabel">CT 6</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTShippingCostCT5" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" required></input>
                                                    <span class="tokenTInputLabel">CT 5</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTShippingCostCT4" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" required></input>
                                                    <span class="tokenTInputLabel">CT 4</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTShippingCostCT3" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" required></input>
                                                    <span class="tokenTInputLabel">CT 3</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTShippingCostCT2" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" required></input>
                                                    <span class="tokenTInputLabel">CT 2</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTShippingCostCT1" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" required></input>
                                                    <span class="tokenTInputLabel">CT 1</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tokenAllocationContainer">
                                            <div class="tokenAllocationHeading">Totals</div>

                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTTotalMQT" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" readonly required></input>
                                                    <span class="tokenTInputLabel">MQ T</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTTotalCT9" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" readonly required></input>
                                                    <span class="tokenTInputLabel">CT 9</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTTotalCT8" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" readonly required></input>
                                                    <span class="tokenTInputLabel">CT 8</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTTotalCT7" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" readonly required></input>
                                                    <span class="tokenTInputLabel">CT 7</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTTotalCT6" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" readonly required></input>
                                                    <span class="tokenTInputLabel">CT 6</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTTotalCT5" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" readonly required></input>
                                                    <span class="tokenTInputLabel">CT 5</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTTotalCT4" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" readonly required></input>
                                                    <span class="tokenTInputLabel">CT 4</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTTotalCT3" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" readonly required></input>
                                                    <span class="tokenTInputLabel">CT 3</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTTotalCT2" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" readonly required></input>
                                                    <span class="tokenTInputLabel">CT 2</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex20">
                                                <div class="tokenTInputContainer">
                                                    <input class="tokenTInput" type="number" name="tokenTTotalCT1" min="0" max="9999999999" step="1" value="0" onfocus="this.select();" readonly required></input>
                                                    <span class="tokenTInputLabel">CT 1</span>
                                                    <span class="tokenTPositiveNegative">&plus;</span>
                                                </div>
                                            </div>
                                        ...
                                        <!--Section End-->
                                        <!--Section Start-->
                                        <div id="tokenTShippingInformationContainer">
                                            <div class="sectionSpacerContainer">
                                                <hr class="tokenTSectionSpacerLine">
                                                <span class="sectionSpacerLabel">Shipping Information</span>
                                            </div>
                                            <div class="textInputContainerFlex50">
                                                <div class="telInputContainer">
                                                    <input class="telInput" type="tel" name="tokenTShippingPhoneNumber" placeholder="" maxlength="20" disabled></input>
                                                    <span class="telInputLabel">Shipping Phone Number</span>
                                                    <span class="extensionPlus">+</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex50">
                                                <div class="txtInputContainer">
                                                    <input class="textInput" type="text" name="tokenTShippingCompany" placeholder="" maxlength="255" disabled></input>
                                                    <span class="floatingLabel">Shipping Company</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex50">
                                                <div class="txtInputContainer">
                                                    <input class="textInput" type="text" name="tokenTShippingFirstName" placeholder="" maxlength="255" required disabled></input>
                                                    <span class="floatingLabel">Shipping First Name *</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex50">
                                                <div class="txtInputContainer">
                                                    <input class="textInput" type="text" name="tokenTShippingLastName" placeholder="" maxlength="255" required disabled></input>
                                                    <span class="floatingLabel">Shipping Last Name *</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex100">
                                                <div class="txtInputContainer" id="tokenTShippingAddressContainer">
                                                    <input class="textInput" type="text" name="tokenTShippingAddress" placeholder="" maxlength="255" required disabled></input>
                                                    <span class="floatingLabel">Shipping Address *</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex50">
                                                <div class="txtInputContainer">
                                                    <input class="textInput" type="text" name="tokenTShippingCity" placeholder="" maxlength="255" required disabled></input>
                                                    <span class="floatingLabel">Shipping City *</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex50">
                                                <div class="txtInputContainer" id="tokenTShippingZIPContainer">
                                                    <input class="textInput" type="text" name="tokenTShippingZIP" placeholder="" maxlength="10" required disabled></input>
                                                    <span class="floatingLabel">Shipping ZIP *</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex50">
                                                <div class="txtInputContainer">
                                                    <input class="textInput" type="text" name="tokenTShippingProvince" placeholder="" maxlength="255" required disabled></input>
                                                    <span class="floatingLabel">Shipping Province *</span>
                                                </div>
                                            </div>
                                            <div class="textInputContainerFlex50">
                                                <div class="dropdownListContainer" id="tokenTShippingCountryContainer">
                                                    <select class="dropdownList" name="tokenTShippingCountry" required disabled>
                                                        <option value="Afghanistan">Afghanistan</option>
                                                    ...
                                                    <span class="dropdownListLabel">Shipping Country *</span>
                                                    <img class="dropdownListArrow" src="./assets/images/DropdownArrowIcon.png"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="sectionSpacerContainer">
                                            <hr class="tokenTSectionSpacerLine">
                                            <span class="sectionSpacerLabel">Administrative Information</span>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="tokenTDropdownListContainer">
                                                <select class="dropdownList" id="tokenTPurchaseType" name="tokenTPurchaseType" required disabled>
                                                    <option value="Gift Certificate">Gift Certificate</option>
                                                    <option value="Self-Purchase">Self-Purchase</option>
                                                    <option value="Gift" disabled>Gift</option>
                                                    <option value="Bundle" disabled>Bundle</option>
                                                    <!--Enabling some of these requires additional features to be added first.-->
                                                </select>
                                                <span class="dropdownListLabel">Purchase Type *</span>
                                                <img class="dropdownListArrow" src="./assets/images/DropdownArrowIcon.png"/>
                                            </div>
                                        </div>
                                        <div class="textAreaInputContainer">
                                            <textarea class="textAreaInput" name="tokenTCustomerRelationshipManagement" placeholder="" maxlength="255"></textarea>
                                            <span class="textAreaFloatingLabel">CRM</span>
                                        </div>
                                        <!--Section End-->
                                        <div class="phpResponse" id="tokenTSubmissionPHPResponse"></div>
                                        <div class="buttonContainer">
                                            <button id="tokenTSubmissionButton" type="submit">SUBMIT</button>
                    ...
                    <div class="contentDisplay" id="invoiceEntryTab"><!--Page Tab-->
                        <div class="contentDisplayNonFlexBox">
                            <div class="container" id="invoiceFormContainer">
                                <div class="internalContainer" id="invoiceFormInternalContainer">
                                    <div id="invoiceFormHeadingContainer">
                                        <img id="invoiceIcon" src="./assets/images/InvoiceIcon.png"/>
                                    </div>
                                    <form id="invoiceDataEntryForm" autocomplete="off" onkeydown="return event.key != 'Enter';">
                                        
                                        <div id="invoiceFormHeading">Invoice Entry</div>
                                        
                                        <div class="requiredFieldsKey">* required</div>

                                        <div class="textInputContainerFlex100">
                                            <div class="dropdownListContainer" id="invoiceCustomerSelectDropdownContainer">
                                                <select class="dropdownList" id="invoiceCustomerSelect" name="invoiceCustomerSelect">
                                                    <option class="dropdownListPlaceholder" value="" selected disabled>Please Select Customer</option>
                                                </select>
                                                <span class="dropdownListLabel">Customer</span>
                                                <img class="dropdownListArrow" src="./assets/images/DropdownArrowIcon.png"/>
                                        ...
                                        <!--Section Start-->
                                        <div class="sectionSpacerContainer">
                                            <hr class="sectionSpacerLine">
                                            <span class="sectionSpacerLabel">Administrative Information</span>
                                        </div>
                                        <div class="textAreaInputContainer">
                                            <textarea class="textAreaInput" name="invoiceCustomerRelationshipManagement" placeholder="" maxlength="255"></textarea>
                                            <span class="textAreaFloatingLabel">CRM</span>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="dropdownListContainer">
                                                <select class="dropdownList" id="invoiceTransactionType" name="invoiceTransactionType" required>
                                                    <option value="Self-Purchase">Self-Purchase</option>
                                                    <option value="Gift" disabled>Gift</option>
                                                    <option value="Bundle" disabled>Bundle</option>
                                                    <!--Enabling some of these requires additional features to be added first.-->
                                        ...
                                        <div class="textInputContainerFlex50">
                                            <div class="dateInputContainer">
                                                <input class="dateInput" type="date" name="invoiceProductEOL"></input>
                                                <span class="dateInputLabel">Product EOL</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex100" id="invoiceGiftRecipientContainer" hidden>
                                            <div class="dropdownListContainer" id="invoiceGiftRecipientDropdownContainer">
                                                <select class="dropdownList" id="invoiceGiftRecipient" name="invoiceGiftRecipient" required disabled>
                                                    <option value="" disabled selected>Please Select Recipient</option>
                                                    <option value=""></option>
                                                </select>
                                                <span class="dropdownListLabel">Gift Recipient *</span>
                                                <img class="dropdownListArrow" src="./assets/images/DropdownArrowIcon.png"/>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex100" id="invoiceBundleQuantityContainer" hidden>
                                            <div class="numberInputContainer">
                                                <input class="numberInput" type="number" id="invoiceBundleQuantity" name="invoiceBundleQuantity" min="1" max="100" value="0" onfocus="this.select();" required disabled></input>
                                                <span class="numberInputLabel">Bundle Quantity *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex100" id="invoiceBundleRecipientContainer" hidden>
                                            <div class="dropdownListContainer" id="invoiceBundleRecipientDropdownContainer">
                                                <select class="dropdownList" id="invoiceBundleRecipient" name="invoiceBundleRecipient" required disabled>
                                                    <option value="" disabled selected>Please Select Recipient</option>
                                                    <option value=""></option>
                                                </select>
                                                <span class="dropdownListLabel">Bundle Recipient *</span>
                                                <img class="dropdownListArrow" src="./assets/images/DropdownArrowIcon.png"/>
                                            </div>
                                        </div>
                                        <!--Section End-->
                                        ...
                                        <div class="sectionSpacerContainer">
                                            <hr class="sectionSpacerLine">
                                            <span class="sectionSpacerLabel">Customer Invoice Information</span>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer" id="invoiceNumberContainer">
                                                <input class="textInput" type="text" id="invoiceNumber" name="invoiceNumber" pattern="[0-9]{4,10}" title="Please input a valid invoice number" placeholder="" maxlength="10" required></input>
                                                <span class="floatingLabel">Invoice Number *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="email" id="invoiceEmail" name="invoiceEmail" placeholder="" maxlength="255" required></input>
                                        ...
                                        <div class="sectionSpacerContainer">
                                            <hr class="sectionSpacerLine">
                                            <span class="sectionSpacerLabel">Payment Information</span>
                                        </div>
                                        <div class="textInputContainerFlex33">
                                            <div class="dropdownListContainer">
                                                <select class="dropdownList" id="invoicePaymentStatus" name="invoicePaymentStatus" required>
                                                    <option value="Pending" selected>Pending</option>
                                                    <option value="Paid">Paid</option>
                                                </select>
                                                <span class="dropdownListLabel">Payment Status *</span>
                                        ...
                                        <div class="textInputContainerFlex33">
                                            <div class="dateInputContainer">
                                                <input class="dateInput" type="date" id="invoicePaidAt" name="invoicePaidAt" required disabled></input>
                                                <span class="dateInputLabel">Paid At *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex33">
                                            <div class="dropdownListContainer">
                                                <select class="dropdownList" id="invoicePaymentType" name="invoicePaymentType" required disabled>
                                                    <option value="" selected></option>
                                                    <option value="Credit Card (Stripe)">Credit Card (Stripe)</option>
                                                    <option value="iDEAL (Stripe)">iDEAL (Stripe)</option>
                                                    <option value="Giropay (Stripe)">Giropay (Stripe)</option>
                                                    <option value="Bancontact (Stripe)">Bancontact (Stripe)</option>
                                                    <option value="SOFORT (Stripe)">SOFORT (Stripe)</option>
                                                    <option value="PayPal">PayPal</option>
                                                    <option value="Bank Transfer">Bank Transfer</option>
                                                </select>
                                                <span class="dropdownListLabel">Payment Type *</span>
                                                <img class="dropdownListArrow" src="./assets/images/DropdownArrowIcon.png"/>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex33">
                                            <div class="dropdownListContainer">
                                                <select class="dropdownList" id="invoiceShippingStatus" name="invoiceShippingStatus" required>
                                                    <option value="Processing" selected>Processing</option>
                                                    <option value="Shipped">Shipped</option>
                                                </select>
                                                <span class="dropdownListLabel">Shipping Status *</span>
                                        ...
                                        <div class="textInputContainerFlex33">
                                            <div class="dateInputContainer">
                                                <input class="dateInput" type="date" id="invoiceShippedAt" name="invoiceShippedAt" required disabled></input>
                                                <span class="dateInputLabel">Shipped At *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex33">
                                            <div class="dropdownListContainer">
                                                <select class="dropdownList" id="invoiceShippingMethod" name="invoiceShippingMethod" required disabled>
                                                    <option value="" selected></option>
                                                    <option value="Digital">Digital</option>
                                                    <option value="Courier">Courier</option>
                                                    <option value="Postal">Postal</option>
                                        ...
                                        <div class="textInputContainerFlex50">
                                            <div class="numberInputContainer">
                                                <input class="textNumberInput" type="text" name="invoiceSubTotal" value="0.00" pattern="(\d{1,20})+([.,]{1}\d{2})" title="Value must include only digits, a '.' or ',' and two decimal places" onfocus="this.select();" maxlength="23" required></input>
                                                <span class="numberInputLabel">Sub Total *</span>
                                                <span class="currency">&euro;</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="numberInputContainer">
                                                <input class="textNumberInput" type="text" name="invoiceShippingCost" value="0.00" pattern="(\d{1,20})+([.,]{1}\d{2})" title="Value must include only digits, a '.' or ',' and two decimal places" onfocus="this.select();" maxlength="23" required></input>
                                                <span class="numberInputLabel">Shipping Cost *</span>
                                                <span class="currency">&euro;</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="numberInputContainer">
                                                <input class="textNumberInput" type="text" name="invoiceVATAdded" value="0.00" pattern="(\d{1,20})+([.,]{1}\d{2})" title="Value must include only digits, a '.' or ',' and two decimal places" onfocus="this.select();" maxlength="23" required></input>
                                                <span class="numberInputLabel">VAT Added *</span>
                                                <span class="currency">&euro;</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="numberInputContainer">
                                                <input class="textNumberInput" type="text" name="invoiceVATIncluded" value="0.00" pattern="(\d{1,20})+([.,]{1}\d{2})" title="Value must include only digits, a '.' or ',' and two decimal places" onfocus="this.select();" maxlength="23" required></input>
                                                <span class="numberInputLabel">VAT Included *</span>
                                                <span class="currency">&euro;</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex100">
                                            <div class="numberInputContainer">
                                                <input class="textNumberInput" type="text" name="invoiceTotal" value="0.00" maxlength="23" readonly required></input>
                                                <span class="numberInputLabel">Total *</span>
                                                <span class="currency">&euro;</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="text" name="invoiceBillingVATNumber" placeholder="" maxlength="50"></input>
                                                <span class="floatingLabel">Billing VAT Number</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="dropdownListContainer">
                                                <select class="dropdownList" name="invoicePaymentMethod" required>
                                                    <option value="Upfront">Upfront</option>
                                                    <option value="Monthly Installment" disabled>Monthly Installment</option>
                                                    <option value="Annual Installment" disabled>Annual Installment</option>
                                                    <option value="Percentage of Income" disabled>Percentage of Income</option>
                                        ...
                                        <div class="textInputContainerFlex100">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="text" name="invoiceTransactionID" placeholder="" maxlength="255"></input>
                                                <span class="floatingLabel">Transaction ID</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="numberInputContainer">
                                                <input class="textNumberInput" type="text" name="invoiceAmountRefunded" value="0.00" pattern="(\d{1,20})+([.,]{1}\d{2})" title="Value must include only digits, a '.' or ',' and two decimal places" onfocus="this.select();" maxlength="23"></input>
                                                <span class="numberInputLabel">Amount Refunded</span>
                                                <span class="currency">&euro;</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="numberInputContainer">
                                                <input class="textNumberInput" type="text" name="invoiceOutstandingBalance" value="0.00" pattern="(\d{1,20})+([.,]{1}\d{2})" title="Value must include only digits, a '.' or ',' and two decimal places" onfocus="this.select();" maxlength="23"></input>
                                                <span class="numberInputLabel">Outstanding Balance</span>
                                                <span class="currency">&euro;</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="dateInputContainer">
                                                <input class="dateInput" type="date" name="invoiceCreatedTime" required></input>
                                                <span class="dateInputLabel">Created Time *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="dateInputContainer">
                                                <input class="dateInput" type="date" name="invoiceCancelledAt"></input>
                                                <span class="dateInputLabel">Cancelled At</span>
                                            </div>
                                        </div>
                                        <!--Section End-->
                                        <!--Section Start-->
                                        ...
                                        <div class="textInputContainerFlex100">
                                            <div class="numberInputContainer">
                                                <input class="numberInput" type="number" id="invoiceProductQuantity" name="invoiceProductQuantity" min="1" max="9999999999" step="1" value="1" onfocus="this.select();" required></input>
                                                <span class="numberInputLabel">Product Quantity *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="dropdownListContainer" id="invoiceProductTypeContainer">
                                                <select class="dropdownList" id="invoiceProductType" name="invoiceProductType" required>
                                                    <option value="Product/Service">Product/Service</option>
                                                    <option value="Credits">Credits</option>
                                                </select>
                                                <span class="dropdownListLabel">Product Type *</span>
                                                <img class="dropdownListArrow" src="./assets/images/DropdownArrowIcon.png"/>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="numberInputContainer" id="invoiceCreditsQuantityContainer" hidden>
                                                <input class="numberInput" type="number" id="invoiceCreditsQuantity" name="invoiceCreditsQuantity" min="1" max="9999999999" step="1" value="" onfocus="this.select();" required disabled></input>
                                                <span class="numberInputLabel">Credits Quantity *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="text" name="invoiceProductName" placeholder="" maxlength="255" required></input>
                                                <span class="floatingLabel">Product Name *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="text" name="invoiceProductOptions" placeholder="" maxlength="255"></input>
                                                <span class="floatingLabel">Product Options</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="numberInputContainer">
                                                <input class="textNumberInput" type="text" name="invoiceProductPrice" value="0.00" pattern="(\d{1,20})+([.,]{1}\d{2})" title="Value must include only digits, a '.' or ',' and two decimal places" onfocus="this.select();" maxlength="23" required></input>
                                                <span class="numberInputLabel">Product Price *</span>
                                                <span class="currency">&euro;</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="text" name="invoiceProductSKU" placeholder="" maxlength="255" required></input>
                                                <span class="floatingLabel">Product SKU *</span>
                                            </div>
                                        </div>
                                        <!--Section End-->
                                        ...
                                        <div class="sectionSpacerContainer">
                                            <hr class="sectionSpacerLine">
                                            <span class="sectionSpacerLabel">Billing Information</span>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="text" name="invoiceBillingFirstName" placeholder="" maxlength="255" required></input>
                                                <span class="floatingLabel">Billing First Name *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="text" name="invoiceBillingLastName" placeholder="" maxlength="255" required></input>
                                                <span class="floatingLabel">Billing Last Name *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex100">
                                            <div class="txtInputContainer" id="invoiceBillingAddressContainer">
                                                <input class="textInput" type="text" name="invoiceBillingAddress" placeholder="" maxlength="255" required></input>
                                                <span class="floatingLabel">Billing Address *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex100">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="text" name="invoiceBillingCompany" maxlength="255" placeholder=""></input>
                                                <span class="floatingLabel">Billing Company</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="text" name="invoiceBillingCity" placeholder="" maxlength="255" required></input>
                                                <span class="floatingLabel">Billing City *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer" id="invoiceBillingZIPContainer">
                                                <input class="textInput" type="text" name="invoiceBillingZIP" placeholder="" maxlength="10" required></input>
                                                <span class="floatingLabel">Billing ZIP *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="text" name="invoiceBillingProvince" placeholder="" maxlength="255" required></input>
                                                <span class="floatingLabel">Billing Province *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="dropdownListContainer" id="invoiceBillingCountryContainer">
                                                <select class="dropdownList" name="invoiceBillingCountry" required>
                                                    <option value="Afghanistan">Afghanistan</option>
                                                    <option value="Aland Islands">Aland Islands</option><!--May need to add support for the special character �, and do the same for ShippingCountry-->
                                                    <option value="Albania">Albania</option>
                                                    <option value="Algeria">Algeria</option>
                                                ...
                                                <span class="dropdownListLabel">Billing Country *</span>
                                                <img class="dropdownListArrow" src="./assets/images/DropdownArrowIcon.png"/>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex100">
                                            <div class="telInputContainer">
                                                <input class="telInput" type="tel" name="invoiceBillingPhoneNumber" placeholder="" maxlength="20"></input>
                                                <span class="telInputLabel">Billing Phone Number</span>
                                                <span class="extensionPlus">+</span>
                                            </div>
                                        </div>
                                        <!--Section End-->
                                        ...
                                        <div class="textInputContainerFlex100">
                                            <label class="checkboxContainer">Same As Billing Information?
                                                <input class="checkboxInput" type="checkbox"  id="invoiceShippingSameAsBilling" name="invoiceShippingSameAsBilling">
                                                <img class="checkboxCheckmark" src="./assets/images/CheckmarkIcon.png"/>
                                                <span class="checkboxCheckmarkBox"></span>
                                            </label>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="text" name="invoiceShippingFirstName" placeholder="" maxlength="255" required></input>
                                                <span class="floatingLabel">Shipping First Name *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="text" name="invoiceShippingLastName" placeholder="" maxlength="255" required></input>
                                                <span class="floatingLabel">Shipping Last Name *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex100">
                                            <div class="txtInputContainer" id="invoiceShippingAddressContainer">
                                                <input class="textInput" type="text" name="invoiceShippingAddress" placeholder="" maxlength="255" required></input>
                                                <span class="floatingLabel">Shipping Address *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex100">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="text" name="invoiceShippingCompany" placeholder="" maxlength="255"></input>
                                                <span class="floatingLabel">Shipping Company</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="text" name="invoiceShippingCity" placeholder="" maxlength="255" required></input>
                                                <span class="floatingLabel">Shipping City *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer" id="invoiceShippingZIPContainer">
                                                <input class="textInput" type="text" name="invoiceShippingZIP" placeholder="" maxlength="10" required></input>
                                                <span class="floatingLabel">Shipping ZIP *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="text" name="invoiceShippingProvince" placeholder="" maxlength="255" required></input>
                                                <span class="floatingLabel">Shipping Province *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="dropdownListContainer" id="invoiceShippingCountryContainer">
                                                <select class="dropdownList" name="invoiceShippingCountry" required>
                                                    <option value="Afghanistan">Afghanistan</option>
                                                    <option value="Aland Islands">Aland Islands</option>
                                                    <option value="Albania">Albania</option>
                                                    <option value="Algeria">Algeria</option>
                                        ...
                                        <div class="textInputContainerFlex100">
                                            <div class="telInputContainer">
                                                <input class="telInput" type="tel" name="invoiceShippingPhoneNumber" placeholder="" maxlength="20"></input>
                                                <span class="telInputLabel">Shipping Phone Number</span>
                                                <span class="extensionPlus">+</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="sectionSpacerContainer">
                                            <hr class="sectionSpacerLine">
                                            <span class="sectionSpacerLabel">Customer Notes</span>
                                        </div>
                                        <div class="textAreaInputContainer">
                                            <textarea class="textAreaInput" name="invoiceUserNotes" placeholder="" maxlength="255"></textarea>
                                            <span class="textAreaFloatingLabel">Customer Notes</span>
                                        </div>
                                        <!--Section End-->
                                        <div class="phpResponse" id="invoiceSubmissionPHPResponse"></div>
                                        <div class="buttonContainer">
                                            <button id="invoiceSubmissionButton" type="submit">SUBMIT</button>
                                            <div class="loadingAnimationContainer">
                                                <div class="bulletPoint" id="bulletPoint1">&#8226;</div>
                                                <div class="bulletPoint" id="bulletPoint2">&#8226;</div>
                                                <div class="bulletPoint" id="bulletPoint3">&#8226;</div>
                    ...
                    <div class="contentDisplay" id="customerWalletTab"><!--Page Tab-->
                    </div>

                    <div class="contentDisplay" id="customerTransactionLogTab"><!--Page Tab-->   
                    </div>

                    <div class="contentDisplay" id="userRegistrationTab"><!--Page Tab-->
                        <div class="contentDisplayNonFlexBox">
                            <div class="container" id="userRegistrationContainer">
                                <div class="internalContainer" id="userRegistrationInternalContainer">
                                    <div id="registrationFormHeadingContainer">
                                        <img id="registrationIcon" src="./assets/images/RegistrationIcon.png"/>
                                    </div>
                                    <form id="userRegistrationForm" autocomplete="off" onkeydown="return event.key != 'Enter';">
                                        <div id="registrationFormHeading">Register New User</div>

                                        <div class="requiredFieldsKey">* required</div>

                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="text" name="registrationFirstName" placeholder="" maxlength="255" required></input>
                                                <span class="floatingLabel">First Name *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="text" name="registrationLastName" placeholder="" maxlength="255" required></input>
                                                <span class="floatingLabel">Last Name *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="email" id="registrationEmail" name="registrationEmail" placeholder="" maxlength="255" required></input>
                                                <span class="floatingLabel">Email *</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="telInputContainer">
                                                <input class="telInput" type="tel" name="registrationPhoneNumber" placeholder="" maxlength="20"></input>
                                                <span class="telInputLabel">Phone Number</span>
                                                <span class="extensionPlus">+</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex100">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="text" name="registrationCompany" maxlength="255" placeholder=""></input>
                                                <span class="floatingLabel">Company</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex100">
                                            <div class="txtInputContainer" id="registrationAddressContainer">
                                                <input class="textInput" type="text" name="registrationAddress" placeholder="" maxlength="255"></input>
                                                <span class="floatingLabel">Address</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="text" name="registrationCity" placeholder="" maxlength="255"></input>
                                                <span class="floatingLabel">City</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer">
                                                <input class="textInput" type="text" name="registrationProvince" placeholder="" maxlength="255"></input>
                                                <span class="floatingLabel">Province</span>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="dropdownListContainer" id="registrationCountryContainer">
                                                <select class="dropdownList" name="registrationCountry">
                                                    <option value="" selected></option>
                                                    <option value="Afghanistan">Afghanistan</option>
                                                    <option value="Aland Islands">Aland Islands</option><!--May need to add support for the special character �, and do the same for ShippingCountry-->
                                                    <option value="Albania">Albania</option>
                                                ...
                                                <span class="dropdownListLabel">Country</span>
                                                <img class="dropdownListArrow" src="./assets/images/DropdownArrowIcon.png"/>
                                            </div>
                                        </div>
                                        <div class="textInputContainerFlex50">
                                            <div class="txtInputContainer" id="registrationZIPContainer">
                                                <input class="textInput" type="text" name="registrationZIPCode" placeholder="" maxlength="10"></input>
                                                <span class="floatingLabel">ZIP Code</span>
                                            </div>
                                        </div>
                                        <div class="phpResponse" id="userRegistrationPHPResponse"></div>
                                        <div class="buttonContainer">
                                            <button id="userRegistrationButton" type="submit">REGISTER</button>
                                            <div class="loadingAnimationContainer">
                                                <div class="bulletPoint" id="bulletPoint1">&#8226;</div>
                                                <div class="bulletPoint" id="bulletPoint2">&#8226;</div>
                                                <div class="bulletPoint" id="bulletPoint3">&#8226;</div>
...
//Functions
    ...
    function FetchCustomerListAJAX()
    {
        var fetchCustomerList = new XMLHttpRequest();

        fetchCustomerList.open("POST", "mqwAdmin_FetchCustomerList.php", true);
        fetchCustomerList.send(null);

        fetchCustomerList.onreadystatechange = function () {
            if (fetchCustomerList.readyState === 4)
            {
                if (fetchCustomerList.status === 200)
                {
                    let fetchedCustomerListArray = JSON.parse(this.responseText);
                    UpdateCustomerSelectDropdown(fetchedCustomerListArray);
                }
            }
        }    
    }

    function UpdateCustomerSelectDropdown(fetchedCustomerListArray)
    {
        var customerDropdownlist1 = document.getElementById('tokenTCustomerSelect');
        var customerDropdownlist2 = document.getElementById('invoiceCustomerSelect');

        for (var i = 0; i < fetchedCustomerListArray.length; i++)
        {
            var newCustomerOptionValue = fetchedCustomerListArray[i]["UserID"];
            var newCustomerOptionText = fetchedCustomerListArray[i]["Email"] + " | " + fetchedCustomerListArray[i]["FirstName"] + " " + fetchedCustomerListArray[i]["LastName"];

            var newCustomerOption1 = document.createElement('option');
            newCustomerOption1.value = newCustomerOptionValue;
            newCustomerOption1.appendChild(document.createTextNode(newCustomerOptionText));
            customerDropdownlist1.appendChild(newCustomerOption1);
            var newCustomerOption2 = document.createElement('option');
            newCustomerOption2.value = newCustomerOptionValue;
            newCustomerOption2.appendChild(document.createTextNode(newCustomerOptionText));
            customerDropdownlist2.appendChild(newCustomerOption2);
        }

        fetchedCustomerListArray = [];
    }
    ...
    function InstantiateEventListeners()
    {
        ...
        //TOKEN TRANSACTION FORM EVENT LISTENERS.
        document.getElementById("tokenTCustomerSelect").addEventListener("change", function() {
            FetchTokenTCustomerInformationAJAX(this.value);
        });

        document.getElementById("tokenTTransactionType").addEventListener("change", function() {
            var tokenTPositiveNegative = document.getElementsByClassName("tokenTPositiveNegative");
            if (this.value == "Tokens Received")
            {
                document.getElementById("tokenTProductEOLContainer").hidden = true;
                document.getElementById("tokenTPaymentAndShippingContainer").style.display = "none";
                document.getElementById("tokenTShippedAt").disabled = true;
                document.getElementById("tokenTShippingMethod").disabled = true;
                document.getElementById("tokenTShippingCostsContainer").style.display = "none";
                ...
                document.getElementById("tokenTPurchaseType").disabled = true;
                document.getElementById("tokenTDataEntryForm").reset();
                for (var i = 0; i < tokenTPositiveNegative.length; i++)
                {
                    tokenTPositiveNegative[i].innerHTML = "&plus;";
                }
            }
            else if (this.value == "Tokens Paid")
            {
                document.getElementById("tokenTProductEOLContainer").hidden = false;
                document.getElementById("tokenTPaymentAndShippingContainer").style.display = "flex";
                for (var i = 0; i < tokenTPositiveNegative.length; i++)
                {
                    tokenTPositiveNegative[i].innerHTML = "&minus;";
                }
                document.getElementById("tokenTShippingCostsContainer").style.display = "flex";
                document.getElementById("tokenTPurchaseType").value = "Self-Purchase";
                document.getElementById("tokenTPurchaseType").disabled = false;
            }
        });

        document.getElementById("tokenTShippingStatus").addEventListener("change", function() {
        ...
        document.getElementById("tokenTShippingMethod").addEventListener("change", function() {
        ...
        var tokenTInputs = document.getElementsByClassName("tokenTInput");
        for (var i = 0; i < tokenTInputs.length; i++)
        {
            if (tokenTInputs[i].name.includes("TTotal") == false)
            {
                tokenTInputs[i].addEventListener("change", function() {
                    if (this.name.includes("tokenTSubtotal"))
                    {
                        let tokenTType = this.name.replace('tokenTSubtotal','');
                        UpdatetokenTInputTotal(tokenTInputs, tokenTType);
                    }
                    else if (this.name.includes("tokenTShippingCost"))
                    {
                        let tokenTType = this.name.replace('tokenTShippingCost','');
                        UpdatetokenTInputTotal(tokenTInputs, tokenTType);
                    }
                });
            }
        ...
        document.getElementById("tokenTDataEntryForm").addEventListener('submit', function(event) {
            event.preventDefault();
            DisableFormWhileProcessing(this);
            SubmitTokenTransactionAJAX(this);
        });

        //INVOICE FORM EVENT LISTENERS.
        document.getElementById("invoiceCustomerSelect").addEventListener("change", function() {
            FetchInvoiceCustomerInformationAJAX(this.value);
        });

        document.getElementById("invoiceTransactionType").addEventListener("change", function() {
            if (this.value == "Self-Purchase")
            {
        ...
        document.getElementById("invoicePaymentStatus").addEventListener("change", function() {
            if (this.value == "Paid")
            {
            ...
            else if (this.value == "Pending")
            {
                ...
                document.getElementById("invoicePaidAt").value = "";
                document.getElementById("invoicePaymentType").disabled = true;
                document.getElementById("invoicePaymentType").value = "";
            }
        });

        document.getElementById("invoiceShippingStatus").addEventListener("change", function() {
            if (this.value == "Shipped")
            {
        ...
        document.getElementById("invoiceDataEntryForm").elements["invoiceSubTotal"].addEventListener("change", function() {
            this.value = this.value.replace(/,/g, '.');
            UpdateInvoiceTotal();
        });
        document.getElementById("invoiceDataEntryForm").elements["invoiceShippingCost"].addEventListener("change", function() {
            this.value = this.value.replace(/,/g, '.');
            UpdateInvoiceTotal();
        });
        document.getElementById("invoiceDataEntryForm").elements["invoiceVATAdded"].addEventListener("change", function() {
            this.value = this.value.replace(/,/g, '.');
            UpdateInvoiceTotal();
        });
        document.getElementById("invoiceDataEntryForm").elements["invoiceVATIncluded"].addEventListener("change", function() {
            this.value = this.value.replace(/,/g, '.');
            UpdateInvoiceTotal();
        });

        document.getElementById("invoiceDataEntryForm").elements["invoiceAmountRefunded"].addEventListener("change", function() {
            this.value = this.value.replace(/,/g, '.');
        });
        document.getElementById("invoiceDataEntryForm").elements["invoiceOutstandingBalance"].addEventListener("change", function() {
            this.value = this.value.replace(/,/g, '.');
        });
        document.getElementById("invoiceDataEntryForm").elements["invoiceProductPrice"].addEventListener("change", function() {
            this.value = this.value.replace(/,/g, '.');
        });

        document.getElementById("invoiceProductType").addEventListener("change", function() {
            if (this.value == "Credits")
            {
                ...
                document.getElementById("invoiceCreditsQuantity").focus();
            }
            else
            {
                ...
                document.getElementById("invoiceCreditsQuantity").value = "";
            }
        });

        document.getElementById("invoiceShippingSameAsBilling").addEventListener("change", function() {
            if (this.checked)
            {
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingFirstName"].disabled = true;
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingFirstName"].value = document.getElementById("invoiceDataEntryForm").elements["invoiceBillingFirstName"].value;
                document.getElementById("invoiceDataEntryForm").elements["invoiceBillingFirstName"].addEventListener("change", UpdateShippingEventListener);
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingLastName"].disabled = true;
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingLastName"].value = document.getElementById("invoiceDataEntryForm").elements["invoiceBillingLastName"].value;
                document.getElementById("invoiceDataEntryForm").elements["invoiceBillingLastName"].addEventListener("change", UpdateShippingEventListener);
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingAddress"].disabled = true;
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingAddress"].value = document.getElementById("invoiceDataEntryForm").elements["invoiceBillingAddress"].value;
                document.getElementById("invoiceDataEntryForm").elements["invoiceBillingAddress"].addEventListener("change", UpdateShippingEventListener);
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingCompany"].disabled = true;
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingCompany"].value = document.getElementById("invoiceDataEntryForm").elements["invoiceBillingCompany"].value;
                document.getElementById("invoiceDataEntryForm").elements["invoiceBillingCompany"].addEventListener("change", UpdateShippingEventListener);
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingCity"].disabled = true;
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingCity"].value = document.getElementById("invoiceDataEntryForm").elements["invoiceBillingCity"].value;
                document.getElementById("invoiceDataEntryForm").elements["invoiceBillingCity"].addEventListener("change", UpdateShippingEventListener);
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingZIP"].disabled = true;
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingZIP"].value = document.getElementById("invoiceDataEntryForm").elements["invoiceBillingZIP"].value;
                document.getElementById("invoiceDataEntryForm").elements["invoiceBillingZIP"].addEventListener("change", UpdateShippingEventListener);
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingProvince"].disabled = true;
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingProvince"].value = document.getElementById("invoiceDataEntryForm").elements["invoiceBillingProvince"].value;
                document.getElementById("invoiceDataEntryForm").elements["invoiceBillingProvince"].addEventListener("change", UpdateShippingEventListener);
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingCountry"].disabled = true;
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingCountry"].value = document.getElementById("invoiceDataEntryForm").elements["invoiceBillingCountry"].value;
                document.getElementById("invoiceDataEntryForm").elements["invoiceBillingCountry"].addEventListener("change", UpdateShippingEventListener);
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingPhoneNumber"].disabled = true;
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingPhoneNumber"].value = document.getElementById("invoiceDataEntryForm").elements["invoiceBillingPhoneNumber"].value;
                document.getElementById("invoiceDataEntryForm").elements["invoiceBillingPhoneNumber"].addEventListener("change", UpdateShippingEventListener);
            ...
            {
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingFirstName"].disabled = false;
                document.getElementById("invoiceDataEntryForm").elements["invoiceBillingFirstName"].removeEventListener("change", UpdateShippingEventListener);
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingLastName"].disabled = false;
                document.getElementById("invoiceDataEntryForm").elements["invoiceBillingLastName"].removeEventListener("change", UpdateShippingEventListener);
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingAddress"].disabled = false;
                document.getElementById("invoiceDataEntryForm").elements["invoiceBillingAddress"].removeEventListener("change", UpdateShippingEventListener);
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingCompany"].disabled = false;
                document.getElementById("invoiceDataEntryForm").elements["invoiceBillingCompany"].removeEventListener("change", UpdateShippingEventListener);
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingCity"].disabled = false;
                document.getElementById("invoiceDataEntryForm").elements["invoiceBillingCity"].removeEventListener("change", UpdateShippingEventListener);
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingZIP"].disabled = false;
                document.getElementById("invoiceDataEntryForm").elements["invoiceBillingZIP"].removeEventListener("change", UpdateShippingEventListener);
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingProvince"].disabled = false;
                document.getElementById("invoiceDataEntryForm").elements["invoiceBillingProvince"].removeEventListener("change", UpdateShippingEventListener);
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingCountry"].disabled = false;
                document.getElementById("invoiceDataEntryForm").elements["invoiceBillingCountry"].removeEventListener("change", UpdateShippingEventListener);
                document.getElementById("invoiceDataEntryForm").elements["invoiceShippingPhoneNumber"].disabled = false;
                document.getElementById("invoiceDataEntryForm").elements["invoiceBillingPhoneNumber"].removeEventListener("change", UpdateShippingEventListener);
        ...
        document.getElementById("invoiceDataEntryForm").addEventListener('submit', function(event) {
            event.preventDefault();
            DisableFormWhileProcessing(this);
            SubmitInvoiceAJAX(this);
        });

        //USER REGISTRATION FORM EVENT LISTENERS.
        document.getElementById("userRegistrationForm").addEventListener('submit', function(event) {
            event.preventDefault();
            DisableFormWhileProcessing(this);
            SubmitUserRegistrationAJAX(this);
        });
    ...
    function FetchTokenTCustomerInformationAJAX(tokenTSelectedUserID)
    {
        fetchedTokenTCustomerInformationArray = [];
        var tokenTSelectedUserIDArrayFormat = "SelectedUserID=" + tokenTSelectedUserID;

        var fetchCustomerInformation = new XMLHttpRequest();

        fetchCustomerInformation.open("POST", "mqwAdmin_FetchCustomerInformation.php", true);
        fetchCustomerInformation.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        fetchCustomerInformation.send(tokenTSelectedUserIDArrayFormat);

        fetchCustomerInformation.onreadystatechange = function () {
            if (fetchCustomerInformation.readyState === 4)
            {
                if (fetchCustomerInformation.status === 200)
                {
                    fetchedTokenTCustomerInformationArray = JSON.parse(this.responseText);
                }
            }
        }
    }

    function FetchInvoiceCustomerInformationAJAX(invoiceSelectedUserID)
    {
        var invoiceSelectedUserIDArrayFormat = "SelectedUserID=" + invoiceSelectedUserID;

        var fetchCustomerInformation = new XMLHttpRequest();

        fetchCustomerInformation.open("POST", "mqwAdmin_FetchCustomerInformation.php", true);
        fetchCustomerInformation.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        fetchCustomerInformation.send(invoiceSelectedUserIDArrayFormat);
        ...
        fetchCustomerInformation.onreadystatechange = function () {
            if (fetchCustomerInformation.readyState === 4)
            {
                if (fetchCustomerInformation.status === 200)
                {
                    fetchedCustomerInformationArray = JSON.parse(this.responseText);

                    document.getElementById("invoiceDataEntryForm").elements["invoiceEmail"].value = fetchedCustomerInformationArray['Email'];
                    document.getElementById("invoiceDataEntryForm").elements["invoiceBillingFirstName"].value = fetchedCustomerInformationArray['FirstName'];
                    document.getElementById("invoiceDataEntryForm").elements["invoiceBillingLastName"].value = fetchedCustomerInformationArray['LastName'];
                    document.getElementById("invoiceDataEntryForm").elements["invoiceBillingPhoneNumber"].value = fetchedCustomerInformationArray['PhoneNumber'];
                    document.getElementById("invoiceDataEntryForm").elements["invoiceBillingCompany"].value = fetchedCustomerInformationArray['Company'];
                    document.getElementById("invoiceDataEntryForm").elements["invoiceBillingAddress"].value = fetchedCustomerInformationArray['Address'];
                    document.getElementById("invoiceDataEntryForm").elements["invoiceBillingCity"].value = fetchedCustomerInformationArray['City'];
                    document.getElementById("invoiceDataEntryForm").elements["invoiceBillingZIP"].value = fetchedCustomerInformationArray['ZIPCode'];
                    document.getElementById("invoiceDataEntryForm").elements["invoiceBillingProvince"].value = fetchedCustomerInformationArray['Province'];
                    document.getElementById("invoiceDataEntryForm").elements["invoiceBillingCountry"].value = fetchedCustomerInformationArray['Country'];
                }
            }
        }
    }

    function UpdatetokenTInputTotal(tokenTInputs, tokenTType)
    {
        let tokenTSubtotalName = "tokenTSubtotal" + tokenTType;
        let tokenTShippingCostName = "tokenTShippingCost" + tokenTType;
        let tokenTTotalName = "tokenTTotal" + tokenTType;

        tokenTInputs[tokenTTotalName].value = parseInt(tokenTInputs[tokenTSubtotalName].value) + parseInt(tokenTInputs[tokenTShippingCostName].value);
    }

    function UpdateInvoiceTotal()
    {
        floatSubTotal = parseFloat(document.getElementById("invoiceDataEntryForm").elements["invoiceSubTotal"].value, 10);
        floatShippingCost = parseFloat(document.getElementById("invoiceDataEntryForm").elements["invoiceShippingCost"].value, 10);
        floatVATAdded = parseFloat(document.getElementById("invoiceDataEntryForm").elements["invoiceVATAdded"].value, 10);

        floatTotal = (floatSubTotal + floatShippingCost + floatVATAdded).toFixed(2);

        document.getElementById("invoiceDataEntryForm").elements["invoiceTotal"].value = floatTotal.toString();
    }

    const UpdateShippingEventListener = function()
    {
        var billingElementName = this.name;
        var shippingElementName = billingElementName.replace("Billing", "Shipping");

        document.getElementById("invoiceDataEntryForm").elements[shippingElementName].value = document.getElementById("invoiceDataEntryForm").elements[billingElementName].value;
    }
    ...
    function SubmitTokenTransactionAJAX(activeForm)
    {
        const tokenTransactionFormElements = document.getElementById("tokenTDataEntryForm").elements;
        const tokenTransactionFormData = new FormData();
        var tokenSubtotalString = "";
        var tokenShippingCostString = "";
        var tokenTotalString = "";

        tokenTransactionFormData.append("tokenTEmail", fetchedTokenTCustomerInformationArray['Email']);

        for (i = 0; i < tokenTransactionFormElements.length; i++)
        {
            if (tokenTransactionFormElements[i].nodeName === "SELECT" || tokenTransactionFormElements[i].nodeName === "INPUT")
            {
                if (tokenTransactionFormElements[i].name.includes("tokenTSubtotal"))
                {
                    if (tokenTransactionFormElements[i].name == "tokenTSubtotalCT1")
                    {
                        let tokenType = tokenTransactionFormElements[i].name.replace('tokenTSubtotal','');
                        tokenSubtotalString = tokenSubtotalString + tokenType + ": " + tokenTransactionFormElements[i].value;
                    }
                    else
                    {
                        let tokenType = tokenTransactionFormElements[i].name.replace('tokenTSubtotal','');
                ...
                else if (tokenTransactionFormElements[i].name.includes("tokenTShippingCost"))
                {
                    if (tokenTransactionFormElements[i].name == "tokenTShippingCostCT1")
                    {
                        let tokenType = tokenTransactionFormElements[i].name.replace('tokenTShippingCost','');
                        tokenShippingCostString = tokenShippingCostString + tokenType + ": " + tokenTransactionFormElements[i].value;
                    }
                    else
                    {
                        let tokenType = tokenTransactionFormElements[i].name.replace('tokenTShippingCost','');
                ...
                else if (tokenTransactionFormElements[i].name.includes("tokenTTotal"))
                {
                    tokenTransactionFormData.append(tokenTransactionFormElements[i].name, tokenTransactionFormElements[i].value);
                    if (tokenTransactionFormElements[i].name == "tokenTTotalCT1")
                    {
                        let tokenType = tokenTransactionFormElements[i].name.replace('tokenTTotal','');
                        tokenTotalString = tokenTotalString + tokenType + ": " + tokenTransactionFormElements[i].value;
                    }
                    else
                    {
                        let tokenType = tokenTransactionFormElements[i].name.replace('tokenTTotal','');
        ...
        tokenTransactionFormData.append("tokenTSubTotal", tokenSubtotalString);
        tokenTransactionFormData.append("tokenTShippingCost", tokenShippingCostString);
        tokenTransactionFormData.append("tokenTTotal", tokenTotalString);
        const loggedInUserID = walletPagePersonalInfoArray["UserID"];
        tokenTransactionFormData.append("tokenTLoggedByUserID", loggedInUserID);

        const submitTokenTransactionForm = new XMLHttpRequest();

        submitTokenTransactionForm.open("POST", "mqwAdmin_SubmitTokenTransactionForm.php", true);
        submitTokenTransactionForm.send(tokenTransactionFormData);

        submitTokenTransactionForm.onreadystatechange = function () {
            if (submitTokenTransactionForm.readyState === 4)
            {
                if (submitTokenTransactionForm.status === 200)
                {
                    if (this.responseText.indexOf("Token transaction successfully submitted!") !== -1)
                    {
                        document.getElementById("tokenTSubmissionPHPResponse").innerHTML = this.responseText;
                        document.getElementById("tokenTDataEntryForm").reset();
                        EnableFormWhenProcessingIsComplete(activeForm, "");
                        var tokenTPositiveNegative = document.getElementsByClassName("tokenTPositiveNegative");
                        document.getElementById("tokenTProductEOLContainer").hidden = true;
                        document.getElementById("tokenTPaymentAndShippingContainer").style.display = "none";
                        document.getElementById("tokenTShippingCostsContainer").style.display = "none";
                ...
                {
                    document.getElementById("tokenTSubmissionPHPResponse").innerHTML = "HTTP Request Error: " + submitTokenTransactionForm.status + ", " + submitTokenTransactionForm.statusText;
                    EnableFormWhenProcessingIsComplete(activeForm, "");
                }
            }
        }
    ...
    function SubmitInvoiceAJAX(activeForm)
    { 
        const invoiceFormElements = document.getElementById("invoiceDataEntryForm").elements;
        const invoiceFormData = new FormData();

        for (i = 0; i < invoiceFormElements.length; i++)
        {
            if (invoiceFormElements[i].name != "invoiceCustomerSelect" && invoiceFormElements[i].name != "invoiceShippingSameAsBilling")
            {
                if (invoiceFormElements[i].nodeName === "TEXTAREA" || invoiceFormElements[i].nodeName === "SELECT" || invoiceFormElements[i].nodeName === "INPUT")
                {
                    invoiceFormData.append(invoiceFormElements[i].name, invoiceFormElements[i].value);
                }
            }
        }
        ...
        const loggedInUserID = walletPagePersonalInfoArray["UserID"];
        invoiceFormData.append("invoiceLoggedByUserID", loggedInUserID);

        const submitInvoiceForm = new XMLHttpRequest();

        submitInvoiceForm.open("POST", "mqwAdmin_SubmitInvoiceForm.php", true);
        submitInvoiceForm.send(invoiceFormData);

        submitInvoiceForm.onreadystatechange = function () {
            if (submitInvoiceForm.readyState === 4)
            {
                if (submitInvoiceForm.status === 200)
                {
                    if (this.responseText == "Invoice successfully submitted!")
                    {
                        document.getElementById("invoiceSubmissionPHPResponse").innerHTML = this.responseText;
                        document.getElementById("invoiceDataEntryForm").reset();
                        EnableFormWhenProcessingIsComplete(activeForm, "");
                    }
                    else if (this.responseText == "logout")
                    {
                ...
                {
                    document.getElementById("invoiceSubmissionPHPResponse").innerHTML = "HTTP Request Error: " + submitInvoiceForm.status + ", " + submitInvoiceForm.statusText;
                    EnableFormWhenProcessingIsComplete(activeForm, "");
                }
            }
        }
    ...
    function SubmitUserRegistrationAJAX(activeForm)
    {
        const registrationFormElements = document.getElementById("userRegistrationForm").elements;
        const registrationFormData = new FormData();
        

        for (i = 0; i < registrationFormElements.length; i++)
        {
            if (registrationFormElements[i].nodeName === "INPUT" || registrationFormElements[i].nodeName === "SELECT")
            {
                registrationFormData.append(registrationFormElements[i].name, registrationFormElements[i].value);
            }
        }

        const initiateUserRegistration = new XMLHttpRequest();

        initiateUserRegistration.open("POST", "mqwAdmin_UserRegistration.php", true);
        initiateUserRegistration.send(registrationFormData);

        initiateUserRegistration.onreadystatechange = function () {
            if (initiateUserRegistration.readyState === 4)
            {
                if (initiateUserRegistration.status === 200)
                {
                    document.getElementById("userRegistrationPHPResponse").innerHTML = this.responseText;

                    if (this.responseText === "Email Address already registered!")
                    {
                        focusTarget = "registrationEmail";
                    }
                    else if (this.responseText === "User registration complete!" || this.responseText.indexOf("An error occured during table creation!") > -1)
                    {
                        document.getElementById('userRegistrationForm').reset();
                        focusTarget = "registrationFirstName";
                    }
                    else if (this.responseText == "logout")
                    {
                        Logout();
                    }
                    EnableFormWhenProcessingIsComplete(activeForm, focusTarget);
                }
                else
                {
                    document.getElementById("phpResponse").innerHTML = "HTTP Request Error: " + initiateUserRegistration.status + ", " + initiateUserRegistration.statusText;
                    focusTarget = "";
                    EnableFormWhenProcessingIsComplete(activeForm, focusTarget);
                }
            }
